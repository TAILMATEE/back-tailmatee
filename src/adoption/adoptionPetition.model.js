...
import {arrayEconomicRange}from './arrayEconomicRange.js'

const AdoptionPetitionSchema = Schema({
    tailUser:{
...
AdoptionPetitionSchema.methods.toJSON = function(){
    const { __v, _id, ...data } = this.toObject()
    data.id = _id
    return data
}

export default model('AdoptionPetition', AdoptionPetitionSchema);